...
class HelpPage extends React.Component {
    render(){
        return(
            <div className="Page">
                <h3> This page will give detailed instructions on how to navigate through the Bark Bark application. </h3>
                ...
                various options available on our home page -- Gmail, Facebook, Twitter, or by creating a username and password. Your information will only be used to store your account, to read more about this you can 
